# Permiso B: vehículos autorizados

Tags: #permiso-b #autorizaciones #vehiculos-autorizados #mma #remolques

## Edad mínima

La edad mínima requerida para obtener el permiso B es de <ins>18 años</ins>.
...
Los automóviles autorizados por el permiso B pueden llevar:
...
Con permiso B y <ins>antigüedad superior a 2 años</ins>, se pueden conducir dentro del territorio nacional automóviles:

- Sin remolque.
- Impulsados por combustibles alternativos.
- Destinados al transporte de mercancías.
- Con MMA <ins>superior a 3.500 kg pero no superior a 4.250 kg</ins>.
- Siempre que el exceso sobre 3.500 kg proceda exclusivamente del exceso de masa del sistema de propulsión.
- Siempre que no se incremente la capacidad de carga respecto al mismo vehículo.

Ejemplos de combustibles alternativos: electricidad, hidrógeno, gas natural y gas licuado del petróleo, GLP.

## Vehículos especiales

El permiso B autoriza:

- Vehículos especiales no agrícolas, o conjuntos de los mismos, cuya velocidad máxima autorizada <ins>no exceda de 40 km/h</ins> y cuya MMA <ins>no exceda de 3.500 kg</ins>.
- Vehículos especiales agrícolas autopropulsados o sus conjuntos.

## En mis palabras

Permiso B no es solo “turismo”. La memoria útil es agruparlo así: pequeños vehículos, automóviles normales, remolques, excepción de mercancías con combustible alternativo y vehículos especiales.

## Idea clave para el examen

Permiso B = <ins>18 años</ins>, automóviles hasta <ins>3.500 kg</ins> y <ins>9 plazas</ins>, remolques según MMA del conjunto, A1 solo con <ins>más de 3 años</ins> y solo en España, combustibles alternativos hasta <ins>4.250 kg</ins> con condiciones, y vehículos especiales con límites propios.
...
- [Real Decreto 818/2009, Reglamento General de Conductores, artículo 4](https://www.boe.es/buscar/act.php?id=BOE-A-2009-9481#a4): regula las clases de permiso, la edad requerida y los vehículos autorizados por el permiso B.
- [Real Decreto 818/2009, Reglamento General de Conductores, artículo 5](https://www.boe.es/buscar/act.php?id=BOE-A-2009-9481#a5): regula condiciones complementarias, incluida la prueba para determinados conjuntos con remolque.
...
[permiso-b-vehiculos-especiales]: permiso-b-vehiculos-especiales.md "Permiso B: vehículos especiales"
